#pragma checksum "C:\Users\Administrator\source\repos\PhotoGallery\PhotoGallery\Views\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "7EF57FC011E612AD16518CDB3479F5F6"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace PhotoGallery
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::PhotoGallery.Common.MovieData dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::PhotoGallery.Common.MovieData) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::PhotoGallery.Common.MovieData)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::PhotoGallery.Common.MovieData obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ImageData(obj.ImageData, phase);
                        this.Update_Title(obj.Title, phase);
                    }
                }
            }
            private void Update_ImageData(global::Windows.UI.Xaml.Media.Imaging.BitmapImage obj, int phase)
            {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::PhotoGallery.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::PhotoGallery.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::PhotoGallery.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_lst(obj.lst, phase);
                    }
                }
            }
            private void Update_lst(global::System.Collections.ObjectModel.ObservableCollection<global::PhotoGallery.Common.MovieData> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
